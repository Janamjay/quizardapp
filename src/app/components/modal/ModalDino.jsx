...
const ModalDino = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div
      className={`fixed font-Montserrat ${
        isOpen ? "block" : "hidden"
      } top-0 left-0 w-full h-[85vh] sm:h-full flex items-end sm:items-center justify-center transition-opacity duration-1000  bg-gray-200 bg-opacity-50 z-50`}
    >
      <div
      ...
      >
        ...
        <button
          ...
          className=" px-4 pb-2 pt-3 font-[Montserrat] text-black dark:text-white rounded  absolute  top-0 right-0 z-10"
          onClick={handleClose}
        >
          <AiOutlineClose
