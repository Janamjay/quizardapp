...
const RulesMulti = ({ isOpen, onClose, children }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-white dark:bg-grey800 absolute  p-6 pt-3 rounded-lg shadow-lg w-full sm:w-[48%] md:w-[50%] ${
          closing
