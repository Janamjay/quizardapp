...
const QuizD = ({ classListData, quizPlayData, quizDetails }) => {
  let interval;
  const params = useParams();
  const quiz_Id = params.quiz_id[0];
  // const question_set_name = params.quiz_id[0];
  const dispatch = useDispatch();
  // const loc = usequizSound();
  // const quizSound = loc.state;
  ...
  //   biologyQuestions[currentQuestion].options
  // );
  ...
  useEffect(() => {
    let interval;
    if (currentQuestion <= quizStart.length) {
  ...
  const moveToNextQuestion = () => {
    ...
    if (currentQuestion < quizStart.length - 1) {
      ...
      setTimeout(() => {
        ...
        // setTimer(60);
        setIsPlaying(true);
        // if (audio && audioState.soundOn && !isModalOpen) {
        //   audio.play();
        // }
        setEnterAnimation("animate__animated animate__fadeInRightBig");
        setExitAnimation("");
  ...
  const submitQuiz = (quiz_Id) => {
    ...
    // biologyQuestions.forEach((question, index) => {
    //   if (
    ...
    setQuizResults((prevResults) => ({
      ...prevResults,
      scoreCounting: prevResults.scoreCounting,
    ...
    <>
      ...
      >
        ...
        <div className="w-full fixed z-50">
          <div>
            <div className="flex items-center  justify-between py-2 sm:py-4 pl-[17px] sm:pr-7 bg-slate-950 rounded-lg relative z-10 ">
              <div className="text-xl md:text-4xl cursor-pointer text-yellow400 max-w-[135px] sm:max-w-full truncate font-[Montserrat]">
                ...
                <div className="text-lg md:text-[2rem]  relative z-10">
                  <div>
                    <Modal isOpen={isModalOpen1} onClose={closeModal1}>
                      <h2 className="text-sm font-bold text-black dark:text-white mb-2">
                        Game Settings
                      </h2>
                ...
                <div className="w-[70px] ">
                  ...
                  >
                    ...
                    <CountUp
                      ...
                      duration={2.5}
                      className="font-black max-w-[15px] min-w-[15px] font-[Montserrat] sm:mb-0"
                    />
                  </button>
                </div>
              </div>
        ...
        >
          <div className="fixed h-[35vh] w-[100%] sm:h-[40vh] sm:min-w-full ">
            <canvas className="gameScene h-full w-full "></canvas>
          </div>
          {loading ? (
            <DNALoader />
          ) : (
            <div className="quiz-card mt-[13rem] sm:mt-[16rem] bg-[#0f0f0f2b] z-10 w-full">
              <div className=" sm:py-[1rem] hidden  relative z-10">
              ...
              <div className="flex justify-between items-center ">
                <div className="sm:mt-5 relative z-10">
                  <h1 className=" text-center font-[Montserrat] text-white ">
                    Question {currentQuestion + 1} of {quizStart.length}
                  </h1>
                </div>
                <div className=" sm:pt-[10px] flex justify-center items-center rounded-full   relative z-10">
                  <h1 className="max-w-[56px] max-h-[56px] text-lg md:text-xl  flex justify-center items-center rounded-[50%] p-5 font-[Montserrat] text-white  relative z-10">
          ...
          <div className="hidden sm:block mt-5 relative z-10">
            <h1 className=" text-center text-white ">
              ...
              /> */}
                  ...
                  // }`}
                  >
                    {/* {ReactHtmlParser(quizStart[currentQuestion]?.question_name)} */}
                    <div
                      ...
                      {quizStart[currentQuestion].options.map(
                        (option, index) => (
                          <li
                            ...
                            className={`text-center sm:hover:shadow-[0px_0px_0px_2px_#ed8936] py-[5px] cursor-pointer min-h-[49px] ${
                              option.image
                                ? "w-[45%] md:max-w-[11rem]"
                                : "w-full"
                            } rounded-lg ${
                          ...
                          >
                            ...
                            {quizStart[currentQuestion].correctAnswers.includes(
                              index
                            ) &&
                              Array.from({ length: 4 }).map((_, coinIndex) => (
                                <img
                                  key={coinIndex}
                                  ref={(el) =>
                                    (coinsRef.current[index * 4 + coinIndex] =
                                      el)
                                  }
                                  src="/images/coin.png"
                                  alt="coin"
              ...
              {status == true ? (
                <div className="pb-4 flex font-[Montserrat] fixed bottom-0 bg-[#231010] left-0 items-center justify-center w-full z-10">
                  <>
                    ...
                    bg-[#d11ab9] text-white rounded-xl  w-[100%] sm:w-[35%] mx-[20px] m-auto
                  ...
                  {quizStart[currentQuestion]?.category === "multi" && (
                    <button
                      ...
                      className={` mb-2 mt-6 md:mt-4 font-[Montserrat] py-2 px-4  bg-[#d11ab9] cursor-pointer text-white rounded-xl  w-[90%] mds:w-[30%] m-auto hover:bg-[#006778] text-[16px] sm:text-lg ${
                        showCorrectAnswer
                          ? "hidden"
                          : optionSelected
                          ? ""
                  ...
                  {currentQuestion === quizStart.length - 1 && (
                    <button
                      ...
                      className="flex justify-center items-center gap-[11px] mb-2 mt-6 md:mt-4 py-2  bg-[#d11ab9] cursor-pointer text-white rounded-xl  w-[100%] sm:w-[35%] mx-[20px] m-auto hover:bg-[#006778] text-[16px] font-[Montserrat] sm:text-lg"
                    >
