...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: BASE_URL + "join/quiz/timerdino/" + quizId,
      url: BASE_URL + "join/quiz/timerdino/" + quizId,
    },
    openGraph: {
      title:  `CountDown Timer | ${ `CountDown Timer | ${SITE_NAME}`}`,
      description:
        "Play Different Type of Quiz From different Topics With different types of Mode Like Dino Mode ....",
        url: BASE_URL + "join/quiz/timerdino/" + quizId,
        siteName: SITE_NAME,
    ...
    metadataBase: BASE_URL + "join/quiz/timerdino/" + quizId,
  };
}