...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Room lobby | ${SITE_NAME}`,
    description:
      "Play Different Type of Quiz From different Topics With different types of Mode Like Dino Mode ....",
    alternates: {
      canonical: BASE_URL + "join/room/roomlobby/" + quizId,
      url: BASE_URL + "join/room/roomlobby/" + quizId,
    },
    openGraph: {
      title: `Room lobby | ${SITE_NAME}`,
      description:
    ...
    metadataBase: BASE_URL + "join/room/roomlobby/" + quizId,
  };
}
