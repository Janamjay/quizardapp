...
const RoomInterfaceDino = ({ soketToken }) => {
  useEffect(() => {
      ...
      if (result.isConfirmed) {
        socketRef.current.emit(
          ...
          (data) => {
            ...
            Swal.fire(
              "Success",
              "You successfully removed the user.",
              "success"
            );
          }
        );
  ...
  // const shareText = location.roomData.share_content;
            ...
            <div className="w-full flex justify-center pt-1 md:p-0 md:py-[2rem] relative z-10 opacity-80">
              <div className="w-[98%]  md:w-[40%] bg-[#31304D] rounded-xl">
                ...
                <div className="pt-[2rem] ">
                  <h1 className="text-xl text-center md:text-4xl font-bold font-[Montserrat] text-white">
                  ...
                  <div className="w-full mx-[17px] grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 sm:mt-[5px]">
                    ...
                    >
                      <div className="flex justify-between items-center flex-row">
                        <div className="flex justify-left items-center gap-10 flex-row">
                          <img
                            src={
              ...
              <div>
                ...
                <div className="tracking-[1px] relative">
                  ...
                  <CopyToClipboard text={url} onCopy={onCopyText}>
                    <button
                      aria-label="copy"
                      className="absolute top-1/2 right-[0.5rem] transform -translate-y-[30px] p-[0.3rem] border rounded-3xl font-[Montserrat] bg-rose200"
                    >
                      Copy
                    </button>
                  </CopyToClipboard>
...
export default RoomInterfaceDino;
